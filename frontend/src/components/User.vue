    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                    ...
                    color="deep-purple lighten-2"
                    text
                    @click="openUpdateUserRole"
            >
                UpdateUserRole
            </v-btn>
            <v-dialog v-model="updateUserRoleDiagram" width="500">
                <UpdateUserRoleCommand
                        @closeDialog="closeUpdateUserRole"
    ...
    export default {
        ...
        methods: {
            ...
            async updateUserRole(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['/users/{user_id}/role'].href), params)
            ...
            openUpdateUserRole() {
                this.updateUserRoleDiagram = true;
            },
            closeUpdateUserRole() {
                this.updateUserRoleDiagram = false;
            },
        },
    }
</script>
